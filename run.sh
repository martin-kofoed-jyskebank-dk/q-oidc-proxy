...
export AUTHENTICATION_ALLOW_ORIGINS="/https://([a-z0-9\\-_]+)\\.my\\.company\\.net/"
...
export BACKEND_HEADER_PROPAGATION=Authorization,corrid,x-app-version,x-app-platform,x-app-device
